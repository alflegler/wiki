...
use Acme\WikiBundle\Model\map\PageTableMap;
...
abstract class BasePagePeer
{
    ...
    const OM_CLASS = 'Acme\\WikiBundle\\Model\\Page';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Acme\\WikiBundle\\Model\\map\\PageTableMap';
    ...
    /** the column name for the parentPath field */
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ParentId', 'Parentpath', 'Pagename', 'Title', 'Text', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'parentId', 'parentpath', 'pagename', 'title', 'text', ),
        BasePeer::TYPE_COLNAME => array (PagePeer::ID, PagePeer::PARENT_ID, PagePeer::PARENTPATH, PagePeer::PAGENAME, PagePeer::TITLE, PagePeer::TEXT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PARENT_ID', 'PARENTPATH', 'PAGENAME', 'TITLE', 'TEXT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'parent_id', 'parentPath', 'pageName', 'title', 'text', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ParentId' => 1, 'Parentpath' => 2, 'Pagename' => 3, 'Title' => 4, 'Text' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'parentId' => 1, 'parentpath' => 2, 'pagename' => 3, 'title' => 4, 'text' => 5, ),
        BasePeer::TYPE_COLNAME => array (PagePeer::ID => 0, PagePeer::PARENT_ID => 1, PagePeer::PARENTPATH => 2, PagePeer::PAGENAME => 3, PagePeer::TITLE => 4, PagePeer::TEXT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PARENT_ID' => 1, 'PARENTPATH' => 2, 'PAGENAME' => 3, 'TITLE' => 4, 'TEXT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'parent_id' => 1, 'parentPath' => 2, 'pageName' => 3, 'title' => 4, 'text' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PagePeer::PARENTPATH);
            $criteria->addSelectColumn(PagePeer::PAGENAME);
            $criteria->addSelectColumn(PagePeer::TITLE);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.parent_id');
            $criteria->addSelectColumn($alias . '.parentPath');
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePagePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Acme\WikiBundle\Model\map\PageTableMap());
      }
    }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(PagePeer::PARENT_ID, $obj->getId());
